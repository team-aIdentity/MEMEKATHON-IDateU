import svgPaths from "./svg-smsk6rghas";
import imgOnlineShop from "figma:asset/5cc1579c1da4864762ce97bb8106cc77383220ef.png";
import img20251126248121 from "figma:asset/6042139a0b353149933fc8e7fce4b7f23d8faabf.png";
...
export default function Community() {
  return (
    <div className="bg-[#0c041e] relative size-full" data-name="Community">
      <div className="absolute h-[604px] left-0 top-0 w-[357px]" data-name="스크린샷 2025-11-26 오후 2.48.12 1">
