import svgPaths from "./svg-06y2t350qk";
...
function Frame() {
  return (
    <div className="absolute bg-[#1976d2] box-border content-stretch flex gap-[15px] items-start left-[calc(50%-0.5px)] p-[15px] rounded-[10px] top-1/2 translate-x-[-50%] translate-y-[-50%]">
      <p className="font-['Roboto:Medium','Noto_Sans_KR:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-[20px] text-nowrap text-white whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        대화 시작하기
      </p>
    </div>
  );
...
function ContinueWithGoogleCentreFixed() {
  return (
    <div className="absolute bg-[#1976d2] h-[54px] left-[calc(50%+1px)] rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08),0px_2px_3px_0px_rgba(0,0,0,0.17)] top-[121px] translate-x-[-50%] w-[286px]" data-name="Continue with Google / Centre / Fixed">
      <Frame />
    </div>
  );
}
...
function ContinueWithGoogleCentreFixed1() {
  return (
    <div className="absolute bg-[#1976d2] h-[54px] left-1/2 rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08),0px_2px_3px_0px_rgba(0,0,0,0.17)] top-[492px] translate-x-[-50%] w-[286px]" data-name="Continue with Google / Centre / Fixed">
      <Frame1 />
    </div>
  );
}
...
function ContinueWithGoogleCentreFixed2() {
  return (
    <div className="absolute bg-white h-[54px] left-1/2 rounded-[10px] shadow-[0px_0px_3px_0px_rgba(0,0,0,0.08),0px_2px_3px_0px_rgba(0,0,0,0.17)] top-[566px] translate-x-[-50%] w-[286px]" data-name="Continue with Google / Centre / Fixed">
      <Frame2 />
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="absolute bg-[rgba(0,0,0,0.75)] h-[640px] left-0 overflow-clip top-0 w-[360px]">
      <div className="absolute bg-white h-[240px] left-1/2 top-[399px] translate-x-[-50%] w-[360px]" />
      <ContinueWithGoogleCentreFixed1 />
      <ContinueWithGoogleCentreFixed2 />
      <p className="absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.8px] left-[calc(50%-0.5px)] not-italic text-[#535353] text-[16px] text-center text-nowrap top-[424px] translate-x-[-50%] whitespace-pre">매칭 시 IDATE 토큰을 소모합니다.</p>
      <p className="absolute font-['Inter:Semi_Bold','Noto_Sans_KR:Bold',sans-serif] font-semibold leading-[16.8px] left-1/2 not-italic text-[#9e9e9e] text-[10px] text-center text-nowrap top-[451px] translate-x-[-50%] whitespace-pre">매칭 시 매칭 기록이 온체인 상에 기록됩니다.</p>
    </div>
  );
}
