import svgPaths from "./svg-ya4lj71kwx";
import imgPhotoArea from "figma:asset/041eefa1d13fff973e2c8cfd1e137211aaeb88f7.png";
...
function Location() {
  return (
    <div className="absolute content-stretch flex gap-[4px] items-center left-[20px] top-[245px] w-[280px]" data-name="Location">
      <MapPin />
      <p className="font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[16.8px] not-italic opacity-90 relative shrink-0 text-[14px] text-nowrap text-white whitespace-pre">Thailand | 남성</p>
    </div>
  );
}
    ...
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full" data-name="Photo Overlay">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col items-start justify-between p-[20px] relative size-full">
          <UserInfo />
          <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[28.8px] left-[20px] not-italic text-[24px] text-white top-[206px] w-[280px]">Malt, 21</p>
          <Location />
        </div>
      </div>
    </div>
